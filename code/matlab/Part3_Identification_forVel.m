...
%
%% Title: 
% Identification Experiments, Forward Velocity
%
%% Description
...
% MatLab to determine estimates for phi-dot and rho-dot. 

%% Parameters of the system/simulation
% This portion of the experiment input input voltages related to forward
...
open_system('Demo1_Identification_forwardVel');
out = sim('Demo1_Identification_forwardVel');
